        ...
        <nav class="bg-white shadow-md border-b">
                    ...
                    <div class="flex items-center gap-12">
                        ...
                        <div class="hidden md:flex items-center gap-8 text-sm font-semibold text-gray-700">
                            ...
                            <a href="{{ route('owner.messages.index') }}"
                                class="{{ request()->routeIs('owner.messages.*')
                                    ? 'text-green-700 border-b-2 border-green-600 pb-1'
                                    : 'hover:text-green-600' }}">
                                Messages
                            </a>
                            ...
                            <a href="{{ route('owner.room-scans.index') }}"
                                class="{{ request()->routeIs('owner.room-scans.*')
                                    ? 'text-green-700 border-b-2 border-green-600 pb-1'
                                    : 'hover:text-green-600' }}">
                                360 Scans
                            </a>

                            <a href="{{ route('owner.cancellation-requests.index') }}"
                                class="{{ request()->routeIs('owner.cancellation-requests.*')
                                    ? 'text-green-700 border-b-2 border-green-600 pb-1'
                                    : 'hover:text-green-600' }}">
                                Cancellations
                            </a>
                            ...
                            <a href="{{ route('owner.reports.index') }}"
                                class="{{ request()->routeIs('owner.reports.*')
                                    ? 'text-green-700 border-b-2 border-green-600 pb-1'
                                    : 'hover:text-green-600' }}">
                                Reports
                            </a>
            ...
            <div class="md:hidden border-t bg-white">
                <div class="px-6 py-4 space-y-4 text-sm font-semibold text-gray-700">
                    ...
                    <a href="{{ route('owner.messages.index') }}" class="block hover:text-green-600">
                        Messages
                    </a>

                    <a href="{{ route('owner.room-scans.index') }}" class="block hover:text-green-600">
                        360 Scans
                    </a>

                    <a href="{{ route('owner.cancellation-requests.index') }}" class="block hover:text-green-600">
                        Cancellations
                    </a>

                    <a href="{{ route('owner.reports.index') }}" class="block hover:text-green-600">
                        Reports
                    </a>
