...
<body class="font-sans antialiased bg-gray-50 text-gray-900">
    ...
    <div class="min-h-screen">
        <nav x-data="{ open: false, userOpen: false, notifOpen: false }" class="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-200">
            ...
            <div x-show="open" x-transition class="md:hidden bg-white border-t border-gray-200 px-4 py-6 space-y-3 text-sm font-medium">
                <a href="{{ route('home-page') }}" class="flex items-center gap-3 text-gray-700 hover:text-green-600">
                    <i class="fa-solid fa-house w-4"></i> Homes
                </a>
                <a href="{{ route('attractions-and-tours') }}" class="flex items-center gap-3 text-gray-700 hover:text-green-600">
                    <i class="fa-solid fa-map w-4"></i> Attraction & Tours
                </a>
                <a href="{{ route('maps') }}" class="flex items-center gap-3 text-gray-700 hover:text-green-600">
                    <i class="fa-solid fa-location-dot w-4"></i> Maps
                </a>
                <a href="{{ route('contact') }}" class="flex items-center gap-3 {{ request()->routeIs('contact') ? 'text-green-700 font-semibold' : 'text-gray-700 hover:text-green-600' }}">
                    <i class="fa-solid fa-envelope w-4"></i> Contact Us
                </a>
                <a href="{{ route('user.messages.index') }}" class="flex items-center gap-3 {{ request()->routeIs('user.messages.*') ? 'text-green-700 font-semibold' : 'text-gray-700 hover:text-green-600' }}">
                    <i class="fa-solid fa-comment-dots w-4"></i> Messages
                </a>
                <div class="border-t border-gray-100 pt-3 mt-1 space-y-2">
                    <a href="{{ $accountRoute }}" class="flex items-center gap-3 text-gray-700 hover:text-green-600">
                        <i class="fa-solid fa-gauge w-4"></i> Dashboard
                    </a>
                    <a href="{{ route('user.cancellation-options.index') }}" class="flex items-center gap-3 text-gray-700 hover:text-green-600">
                        <i class="fa-solid fa-ban w-4"></i> Cancellations
                    </a>
                    <a href="{{ route('user.reports.index') }}" class="flex items-center gap-3 text-gray-700 hover:text-green-600">
                        <i class="fa-solid fa-flag w-4"></i> Reports
                    </a>
        ...
        <footer class="relative bg-gradient-to-r from-green-950 via-green-900 to-green-900 text-white overflow-hidden">
            <div class="relative max-w-7xl mx-auto px-6 py-16">
                ...
                <div class="mt-12 flex flex-col items-center justify-between gap-4 border-t border-green-700 pt-6 text-xs text-green-200 sm:flex-row">
