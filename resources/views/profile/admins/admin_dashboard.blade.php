...
<div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="mb-10 rounded-2xl bg-white p-6 shadow">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Neighbourhood Reports</h2>
                <p class="mt-2 text-sm text-gray-600">
                    Admin can review every report, see the host follow-up, and send official InapDesa messages directly to the host when needed.
                </p>
            </div>
