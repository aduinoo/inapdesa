    ...
    <section class="bg-[#f8f5ec] py-10 sm:py-12">
        <div class="mx-auto max-w-7xl px-2 sm:px-6">
            ...
            <div class="mt-8 grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_380px]">
                <div class="rounded-[2rem] border border-[#d8d2be] bg-white shadow-[0_30px_60px_rgba(15,23,42,0.08)]">
                    <div class="border-b border-[#ece6d6] px-5 py-5 sm:px-6">
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <button id="map-reset-btn" type="button" class="inline-flex items-center gap-2 rounded-full bg-green-800 px-4 py-2 text-sm font-bold text-white shadow-md">
