...
class OwnerApplicationController extends Controller
{
    ...
    {
        $applications = DB::table('owner_applications')
            ...
            ->orderByDesc('owner_applications.created_at')
            ->get();

        return view('profile.admins.owner_applications.index', compact('applications'));
    }
